...
ax.set_xticklabels(list(atom_labels))  # 旋转45度避免重叠

# 调整药物名称标签
ax.set_xlabel(drug1_name,
             fontsize=12,
             labelpad=12,
             position=(0.5, -0.2))
...
plt.savefig(f'{drug1_name}_attention_heatmap.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{drug1_name}_attention_heatmap.pdf', bbox_inches='tight')
plt.show()