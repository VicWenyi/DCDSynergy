...
class BiCrossAttention(nn.Module):
    ...
    def scaled_dot_product_attention(self, Q, K, V):
        ...
        return output, attn  # Return both the output and attention weights
    ...
    def forward(self, Zc, Zp):
        ...
        attn_output1,attn_map1 = self.scaled_dot_product_attention(Q1, K1, V1)
        attn_output1 = self.combine_heads(attn_output1)  # [batch, n_c, drug_dim]
        attn_map1 = attn_map1.squeeze(0)
        ...
        attn_output2,attn_map2 = self.scaled_dot_product_attention(Q2, K2, V2)
        attn_output2 = self.combine_heads(attn_output2)  # [batch, n_p, protein_dim]
        attn_map2 = attn_map2.squeeze(0)
        ...
        attention_list = [attn_map1, attn_map2]

        return combined, attention_list
